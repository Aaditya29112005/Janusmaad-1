        ...
        <div id="talk-to-us" className="bg-ink text-white rounded-3xl p-8 sm:p-12 space-y-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <a
                  href="https://wa.me/919818747001?text=Hi%20JanusMAAD,%20I'd%20like%20to%20discuss%20growing%20my%20brand."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3.5 p-3 rounded-xl bg-emerald-500 text-white hover:bg-emerald-600 transition-colors group shadow-sm"
                >
